...
<head>
    ...
    <meta charset="utf-8" />
    <title>Trạng thái đơn hàng | Shoes World</title>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Truy cập vào trạng thái đơn hàng</li>
                                    </ol>
                                </div>
                            ...
                            <div class="h-100">
                                ...
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <!-- <a href="?act=from-them-nguoi-dung" class="btn btn-soft-success material-shadow-none"><i class="ri-add-circle-line align-middle me-1"></i> Thêm Trạng Thái</a> -->
                                    </div><!-- end card header -->
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="hstack gap-3 flex-wrap">
                                                                        ...
                                                                        <form action="?act=xoa-trang-thai" method="post" onsubmit="return confirm('bạn có chắc chắn xóa')">
